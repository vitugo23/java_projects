...
public class StoreService {
    ...
    public Store persistStore(Store store) {
        return storeRepository.save(store); // ✅ Persist the store using save()
    }
    ...
    public List<Store> getAllStores() {
        return storeRepository.findAll(); // ✅ Get all stores
    }
    ...
    public Store getStoreById(long id) {
        return storeRepository.findById(id).orElse(null); // ✅ Return store or null if not found
    }
    ...
    public Store updateStore(long id, Store replacement) {
        ...
        if (optionalStore.isPresent()) {
            ...
            return storeRepository.save(existingStore); // ✅ Save the modified instance
        }
        return null;
    }
}
